...
export default function Login() {
    ...
    <StatusBar barStyle="light-content" backgroundColor='#305BCC' />
    ...
    const handleLogin = async () => {
        ...
        if (userData) {
            ...
            if (user.usuario === usuario && user.senha === senha) {
                ...
                await AsyncStorage.setItem('currentUser', JSON.stringify({ email: user.email, usuario: user.usuario }));
                navigation.navigate('home'); // Navega para a tela de splash
            } else {
